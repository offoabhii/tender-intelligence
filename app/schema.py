...
class Tender(BaseModel):
    ...
    confidence: Literal["HIGH", "MEDIUM", "LOW", "NOT SURE"] = "MEDIUM"
    evidence: Optional[str] = Field(default="NOT SURE")

    @field_validator("closing_date", "issued_by", "qualification_criteria", "eligibility_status", "evidence", mode="before")
    @classmethod
